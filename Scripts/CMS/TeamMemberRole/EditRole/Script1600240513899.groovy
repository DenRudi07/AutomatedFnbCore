...
WebUI.setText(findTestObject('CMS/TeamMemberRole/LabelRoleName'), '1')

WebUI.click(findTestObject('CMS/TeamMemberRole/BtnSave'))

WebUI.verifyTextPresent('Team role has been updated. will only affect the respective team member after they re-login', true)
